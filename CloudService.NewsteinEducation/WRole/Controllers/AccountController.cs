...
namespace WRole.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            return RedirectToAction("ThankYou", "Start");
        }
        ...
        //
        // GET: /Account/Manage
        public ActionResult ManageStudent(ManageMessageId? message)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ManageStudent(ManageUserViewModel model)
        {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            {
                await SignInAsync(user, isPersistent: false);
                //return RedirectToAction("LogOffBeta");
                //return RedirectToAction("ThankYou", "Start");
        ...
        public ActionResult LogOffBeta()
        {
            AuthenticationManager.SignOut();
            return RedirectToAction("Index", "Home");
